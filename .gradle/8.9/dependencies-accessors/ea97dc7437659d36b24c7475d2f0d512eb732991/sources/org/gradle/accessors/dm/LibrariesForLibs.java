...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxEmojiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>emoji</b> with <b>androidx.emoji:emoji</b> coordinates and
        ...
        /**
         * Dependency provider for <b>bundled</b> with <b>androidx.emoji:emoji-bundled</b> coordinates and
         * with version reference <b>emojiBundled</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class AndroidxUiLibraryAccessors extends SubDependencyFactory {
        private final AndroidxUiGeometryLibraryAccessors laccForAndroidxUiGeometryLibraryAccessors = new AndroidxUiGeometryLibraryAccessors(owner);

        public AndroidxUiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.ui.geometry</b>
         */
        public AndroidxUiGeometryLibraryAccessors getGeometry() {
            return laccForAndroidxUiGeometryLibraryAccessors;
        }

    }

    public static class AndroidxUiGeometryLibraryAccessors extends SubDependencyFactory {

        public AndroidxUiGeometryLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>androidx.compose.ui:ui-geometry-android</b> coordinates and
         * with version reference <b>uiGeometryAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("androidx.ui.geometry.android");
        }
    ...
    public static class FirebaseLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>bomVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>biometricKtx</b> with value <b>1.4.0-alpha02</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>bomVersion</b> with value <b>33.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getBomVersion() { return getVersion("bomVersion"); }
        ...
        /**
         * Version alias <b>emoji</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>emojiBundled</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>uiGeometryAndroid</b> with value <b>1.7.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getUiGeometryAndroid() { return getVersion("uiGeometryAndroid"); }
